    ...
    for (let c of classes) {
      ...
      if (!hasClass) {
        ...
        searchForItems.push({
          ...
          search: `add student class ${c.name.toLowerCase()} ${
            c.nameOfNumeric
          }`,
        });
        ...
        searchForItems.push({
          ...
          search: `create exam in class ${c.name.toLowerCase()} ${
            c.nameOfNumeric
          }`,
        });
        ...
        searchForItems.push({
          ...
          search: `create results in class ${c.name.toLowerCase()} ${
            c.nameOfNumeric
          }`,
        });
        ...
        searchForItems.push({
          ...
          search: `passed results in class ${c.name.toLowerCase()} ${
            c.nameOfNumeric
          }`,
        });
        searchForItems.push({
          ...
          search: `failed results in class ${c.name.toLowerCase()} ${
            c.nameOfNumeric
          }`,
        });
      }
...
exports.userChangePasswordPostController = async (req, res, next) => {
  try {
    ...
    if (!matchedPassword) {
      req.flash(
        "fail",
        "Old Password Dosen't Macthed, Please Provied Valid Old Password."
      );
      return res.redirect("back");
    }
