...
"use strict";
eval("\n\nvar _result = __webpack_require__(/*! ./result */ \"./public/scripts/result.js\");\n\nvar _result2 = _interopRequireDefault(_result);\n\nvar _contact = __webpack_require__(/*! ./contact */ \"./public/scripts/contact.js\");\n\nvar _contact2 = _interopRequireDefault(_contact);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nvar btns = document.querySelectorAll('.dropDownToggler');\nvar dropMenus = document.querySelectorAll('.dropDown-style');\n\nbtns.forEach(function (btn, indBtn) {\n\tvar isEnabled = false;\n\tbtn.addEventListener('click', function () {\n\t\tdropMenus.forEach(function (dropMenu, dropInd) {\n\t\t\tif (indBtn === dropInd) {\n\t\t\t\tvar cssDrop = getComputedStyle(dropMenu);\n\t\t\t\tif (cssDrop.display === 'none') {\n\t\t\t\t\tdropMenu.classList.add('drop-show');\n\t\t\t\t\tdropMenu.classList.remove('drop-hide');\n\t\t\t\t\tisEnabled = true;\n\t\t\t\t} else {\n\t\t\t\t\tdropMenu.classList.remove('drop-show');\n\t\t\t\t\tdropMenu.classList.add('drop-hide');\n\t\t\t\t}\n\t\t\t} else {\n\t\t\t\tdropMenu.classList.remove('drop-show');\n\t\t\t\tdropMenu.classList.add('drop-hide');\n\t\t\t}\n\t\t\tif (indBtn === dropInd) {\n\n\t\t\t\twindow.ondblclick = function () {\n\t\t\t\t\tif (isEnabled) {\n\t\t\t\t\t\tdropMenu.classList.remove('drop-show');\n\t\t\t\t\t\tdropMenu.classList.add('drop-hide');\n\t\t\t\t\t}\n\t\t\t\t};\n\t\t\t}\n\t\t});\n\t});\n});\n\n//# sourceURL=webpack:///./public/scripts/index.js?");

/***/ }),

/***/ "./public/scripts/result.js":
/*!**********************************!*\
  !*** ./public/scripts/result.js ***!
  \**********************************/
/*! no static exports found */
